...
<section class="container-fluid content py-5">
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-7 text-center">
            <h1>POO con Javascript, tiempo record</h1>
            <hr>
            <img src="images/8.png" alt="Post Javascript" class="img-fluid">

            <p class="text-left mt-3 post-txt">
                <span>Autor: killbill</span>
                <span class="float-right">Publicado: Hace 2 días</span>
            </p>
            <p class="text-left">
        ...
        <div class="col-md-3 offset-md-1">
            ...
            <div class="row mb-4">
                ...
                <div class="col-7 pl-0">
                    <a href="#" class="link-post">PHP sigue vivo</a>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 col-12 justify-content-center mb-5">
            <div class="card m-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                    <small class="card-txt-category">Categoría: Programación</small>
                    <h5 class="card-title my-2">Aprende PHP y el manejo de datos</h5>
                    <div class="d-card-text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Sed voluptatum ab cumque quisquam quod nesciunt fugiat,
                        eius corrupti nulla veniam, molestias nemo repudiandae?
